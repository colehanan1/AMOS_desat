...
def apply_mask(original_img, mask_img):
    ...
    # Clip and convert to ensure uniformity
    masked_data = np.clip(masked_data, 0, 255)
    masked_data = masked_data.astype(np.uint8)  # This ensures the data type is uniform
